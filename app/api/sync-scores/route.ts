...
// football-data.org stage + matchday → our Round
...
export async function GET(req: NextRequest) {
  // Verify cron secret (skip check if no secret configured)
  ...
  // Server-side Supabase client (bypasses RLS via service role or falls back to anon)
