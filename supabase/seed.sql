...
-- To change a PIN: UPDATE users SET pin_hash = encode(sha256('NEWPIN'::bytea), 'hex') WHERE display_name = 'Name';
...
-- Seed 48 confirmed 2026 World Cup teams
...
insert into teams (name, tier, flag_emoji, confederation, fifa_group, fifa_ranking, is_debut) values
  ...
  ('Senegal',              2, '🇸🇳', 'CAF',       'I', 13, false),
  ('Mexico',               2, '🇲🇽', 'CONCACAF',  'A', 14, false),
  ('United States',        2, '🇺🇸', 'CONCACAF',  'D', 15, false),
  ('Uruguay',              2, '🇺🇾', 'CONMEBOL',  'H', 16, false),
  ...
  ('Canada',               3, '🇨🇦', 'CONCACAF',  'B', 25, false),
  ('Ivory Coast',          3, '🇨🇮', 'CAF',       'E', 26, false),
  ('Qatar',                3, '🇶🇦', 'AFC',       'B', 27, false),
  ('Algeria',              3, '🇩🇿', 'CAF',       'J', 28, false),
  ('Sweden',               3, '🇸🇪', 'UEFA',      'F', 29, false),
  ('Tunisia',              3, '🇹🇳', 'CAF',       'F', 30, false),
  ('Czechia',              3, '🇨🇿', 'UEFA',      'A', 31, false),
  ('Turkey',               3, '🇹🇷', 'UEFA',      'D', 32, false),
  ('Norway',               3, '🇳🇴', 'UEFA',      'I', 33, false),
  ('Scotland',             3, '🏴󠁧󠁢󠁳󠁣󠁴󠁿', 'UEFA',      'C', 34, false),
  ('DR Congo',             3, '🇨🇩', 'CAF',       'K', 35, false),
  ('Bosnia & Herzegovina', 3, '🇧🇦', 'UEFA',      'B', 36, false),
  -- TIER 4 — Underdogs (FIFA #48+)
  ('Panama',               4, '🇵🇦', 'CONCACAF',  'L', 48, false),
  ('Saudi Arabia',         4, '🇸🇦', 'AFC',       'H', 50, false),
  ('South Africa',         4, '🇿🇦', 'CAF',       'A', 55, false),
  ('Iraq',                 4, '🇮🇶', 'AFC',       'I', 60, false),
  ('Uzbekistan',           4, '🇺🇿', 'AFC',       'K', 65, true),
  ('Paraguay',             4, '🇵🇾', 'CONMEBOL',  'D', 70, false),
  ('Ghana',                4, '🇬🇭', 'CAF',       'L', 75, false),
  ('Jordan',               4, '🇯🇴', 'AFC',       'J', 80, true),
  ('Cape Verde',           4, '🇨🇻', 'CAF',       'H', 85, true),
  ('Curacao',              4, '🇨🇼', 'CONCACAF',  'E', 90, true),
  ('Haiti',                4, '🇭🇹', 'CONCACAF',  'C', 95, false),
  ('New Zealand',          4, '🇳🇿', 'OFC',       'G', 100, false)
